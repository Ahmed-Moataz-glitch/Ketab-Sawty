          ...
          onGenerateRoute: (settings) {
            switch (settings.name) {
              case AppRoutes.uploadPdf:
                ...
                return MaterialPageRoute(builder: (_) => UploadPdfPage(homeCubit: homeCubit));
              case AppRoutes.pdfView:
                final args = settings.arguments as Map<String, dynamic>;
                final homeCubit = args['homeCubit'] as HomeCubit;
                final pdfDetailsModel = args['pdfDetailsModel'] as PdfDetailsModel;
              ...
              case AppRoutes.audioPlayer:
                ...
                return MaterialPageRoute(builder: (_) => AudioPlayerPage(pdfDetailsModel: pdfDetailsModel, audioFile: audioFile));
              case AppRoutes.processing:
                final args = settings.arguments as Map<String, dynamic>;
                final homeCubit = args['homeCubit'] as HomeCubit;
                final pdfDetailsModel = args['pdfDetailsModel'] as PdfDetailsModel;
                return MaterialPageRoute(builder: (_) => ProcessingPage(homeCubit: homeCubit, pdfDetailsModel: pdfDetailsModel));
              default:
                return MaterialPageRoute(builder: (_) => const BottomNavBarWidget());
            }
          },
