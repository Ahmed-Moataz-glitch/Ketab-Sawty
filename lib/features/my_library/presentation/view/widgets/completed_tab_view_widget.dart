...
class CompletedTabViewWidget extends StatefulWidget {
  final MyLibraryCubit myLibraryCubit;
  final HomeCubit homeCubit;
  const CompletedTabViewWidget({
    super.key,
  ...
  @override
  State<CompletedTabViewWidget> createState() => _CompletedTabViewWidgetState();
}

class _CompletedTabViewWidgetState extends State<CompletedTabViewWidget> {
  @override
  void initState() {
    super.initState();
